        ...
        return(
            <View style = {QuantityStyles.container}>
                ...
                <View style = {QuantityStyles.button_quantity}>
                    ...
                    <TouchableOpacity 
                        style = {[QuantityStyles.button_style, (this.props.quantity == 'Length') ? QuantityStyles.button_style_length : QuantityStyles.button_style_default]}
                    ...
                    <TouchableOpacity 
                        style = {[QuantityStyles.button_style, (this.props.quantity == 'Temperature') ? QuantityStyles.button_style_temperature : QuantityStyles.button_style_default]}
                    ...
                    <TouchableOpacity 
                        style = {[QuantityStyles.button_style, (this.props.quantity == 'Volume') ? QuantityStyles.button_style_volume : QuantityStyles.button_style_default]}
